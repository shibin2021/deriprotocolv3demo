...
export class PoolImplementation__lpInfosResult {
  value0: Address;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class PoolImplementation__tdInfosResult {
  value0: Address;
  value1: BigInt;
...
export class PoolImplementation extends ethereum.SmartContract {
  static bind(address: Address): PoolImplementation {
    return new PoolImplementation("PoolImplementation", address);
  }
  ...
  lpInfos(param0: BigInt): PoolImplementation__lpInfosResult {
    let result = super.call(
      "lpInfos",
    ...
    return new PoolImplementation__lpInfosResult(
      result[0].toAddress(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_lpInfos(
    param0: BigInt
  ): ethereum.CallResult<PoolImplementation__lpInfosResult> {
    let result = super.tryCall(
      "lpInfos",
      "lpInfos(uint256):(address,int256,int256,int256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    return ethereum.CallResult.fromValue(
      new PoolImplementation__lpInfosResult(
        value[0].toAddress(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt()
  ...
  tdInfos(param0: BigInt): PoolImplementation__tdInfosResult {
    let result = super.call("tdInfos", "tdInfos(uint256):(address,int256)", [
      ethereum.Value.fromUnsignedBigInt(param0)
    ]);

    return new PoolImplementation__tdInfosResult(
      result[0].toAddress(),
      result[1].toBigInt()
    );
  }
  ...
  try_tdInfos(
    param0: BigInt
  ): ethereum.CallResult<PoolImplementation__tdInfosResult> {
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new PoolImplementation__tdInfosResult(
        value[0].toAddress(),
        value[1].toBigInt()
      )
    );
