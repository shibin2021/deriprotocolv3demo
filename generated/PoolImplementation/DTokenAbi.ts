...
export class DTokenAbi extends ethereum.SmartContract {
  ...
  try_exists1(owner: Address): ethereum.CallResult<boolean> {
  ...
  getOwnerOf(tokenId: BigInt): Address {
  ...
  try_getOwnerOf(tokenId: BigInt): ethereum.CallResult<Address> {
  ...
  getTokenIdOf(owner: Address): BigInt {
    let result = super.call("getTokenIdOf", "getTokenIdOf(address):(uint256)", [
      ethereum.Value.fromAddress(owner)
    ]);
  ...
  try_getTokenIdOf(owner: Address): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "getTokenIdOf",
      "getTokenIdOf(address):(uint256)",
      [ethereum.Value.fromAddress(owner)]
    );
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  try_mint(owner: Address): ethereum.CallResult<BigInt> {
